	...
	: Super(ObjectInitializer)
{
	...
	FormatAllPadding = FIntVector2(600, 200);
	...
	BlueprintParameterPadding = FIntVector2(40, 25);
	...
	const FIntVector2 DefaultFormatterPaddingSize(100, 100);
	...
	NotYetDialogueSettings.Padding = FIntVector2(DefaultFormatterPaddingSize.X, DefaultFormatterPaddingSize.Y * 0.5f);
	...
	CommentNodePadding = FIntVector2(30, 30);
