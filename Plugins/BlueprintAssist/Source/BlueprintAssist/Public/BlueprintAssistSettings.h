...
struct FBAKnotTrackSettings
{
	...
	UPROPERTY(EditAnywhere, config, Category = "BlueprintFormatting")
	FIntVector2 LoopingOffset = FIntVector2(0, 0);
};
...
struct FBAFormatterSettings
{
	...
	FBAFormatterSettings(FIntVector2 InPadding, EBAAutoFormatting InAutoFormatting, EEdGraphPinDirection InFormatterDirection, TArray<FName> InRootNodes = TArray<FName>())
		: Padding(InPadding)
	...
	UPROPERTY(EditAnywhere, config, Category=FormatterSettings, meta = (EditCondition = "bEnabled"))
	FIntVector2 Padding = FIntVector2(96, 96);
...
public:
	...
	UPROPERTY(EditAnywhere, config, Category = BlueprintFormatting)
	FIntVector2 BlueprintParameterPadding;
	...
	UPROPERTY(EditAnywhere, config, Category = CommentSettings)
	FIntVector2 CommentNodePadding;
