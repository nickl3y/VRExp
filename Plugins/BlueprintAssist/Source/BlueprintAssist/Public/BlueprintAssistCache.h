...
protected:
	UPROPERTY()
	FIntVector2 Size = FIntVector2(0, 0); // node size

	UPROPERTY()
	FIntVector2 BSize = FIntVector2(0, 0); // comment bubble size
public:
	...
	const FIntVector2& GetNodeSize() const { return Size; }
	...
	const FIntVector2& GetCommentBubbleSize() const { return BSize; }
};
